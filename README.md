...
*There is an example template that is used by my blog, forked from Start bootstrap, [see it here](https://github.com/codernr/startbootstrap-clean-blog).*
...
Since this is a command line tool, it can be used in an automated setup. My own blog is generated this way; a [source repository](https://github.com/codernr/blog-source) is set up to trigger the generation of files and a git push to my [user site repository](https://github.com/codernr/codernr.github.io). For details, see the [workflow file](https://github.com/codernr/blog-source/blob/master/.github/workflows/main.yml).